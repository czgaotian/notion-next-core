...
Note that using the official API with `notion-compat` is **significantly slower** than using the unofficial API via `notion-client` because of [reasons](https://github.com/czgaotian/notion-next-core/issues/269#issuecomment-1100648873).
